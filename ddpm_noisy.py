...
### change this
    def prepare_noise_schedule(self):
        ...
        sigmagrad = (1/(noise_steps-1))*(self.sigma_min**(1/p) - self.sigma_max**(1/p))*p*(self.sigma_max**(1/p) + i*(self.sigma_min**(1/p) - self.sigma_max**(1/p)))**(p-1)
        schedule = [t, torch.ones(self.noise_steps), sigmagrad, torch.zeros(self.noise_steps)]
        return schedule
